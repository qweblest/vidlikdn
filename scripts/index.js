...
x = setInterval(function() {
  ...
  let w = (c.width = window.innerWidth),
    ...
    hh = h / 2,
    opts = {
      strings: ['Вітаю', 'з Днем народження!',  config.name, 'Бажаю тобі безмежного щастя', 'Здійснення всіх мрій', 'Та натхнення для нових звершень', 'Нехай кожен день буде сповнений радості', 'Любові та тепла'],
      charSize: 30,
      charSpacing: 35,
      lineHeight: 40,
